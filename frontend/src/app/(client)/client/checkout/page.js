    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Pulse rings */}
                <span className="absolute inset-0 rounded-full animate-ping bg-[#2E7D32]/10" style={{ animationDuration: "1.2s" }} />
            </motion.div>
            ...
            <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                >
                    ...
                    <div className="rounded-xl border border-[rgba(0,0,0,0.06)] bg-white p-5">
                        ...
                        <p className="text-xl font-bold font-mono text-[#C2185B] tracking-wider">{order.orderNumber}</p>
                        ...
                        <div className="space-y-3">
                            {order.items?.map((item) => (
                                <div key={item.id} className="flex items-center gap-3">
                                    <div className="w-10 h-12 rounded-md bg-[#F4F0F8] overflow-hidden shrink-0 relative">
                                    ...
                                    <p className="text-sm font-semibold font-mono text-[#0D0D0D] shrink-0">
                        ...
                        <div className="flex items-center justify-between">
                            <p className="text-sm font-semibold text-[#0D0D0D]">Total</p>
                            <p className="text-xl font-bold font-mono text-[#C2185B]">{formatCurrency(grandTotal)}</p>
                        </div>
                    </div>

                    {/* Next steps callout */}
                    <div className="rounded-xl bg-[#E8F5E9] border border-[#2E7D32]/15 p-4 flex gap-3">
                        <Info size={16} className="text-[#2E7D32] shrink-0 mt-0.5" />
                        <div>
                            <p className="text-sm font-semibold text-[#2E7D32] mb-1">What happens next?</p>
                            <p className="text-xs text-[#2E7D32]/80 leading-relaxed">
...
export default function CheckoutPage() {
    ...
    if (cartLoading) {
        return (
            <div className="max-w-5xl mx-auto">
                <div className="h-8 w-40 rounded-lg bg-[#F4F0F8] animate-pulse mb-8" />
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-6">
                    <div className="space-y-4">
                        {[1, 2].map((i) => (
                            <div key={i} className="rounded-xl border border-[rgba(0,0,0,0.06)] bg-white p-5 h-40 animate-pulse" />
                        ))}
                    </div>
                    <div className="rounded-xl bg-[#1A1A2E] h-96 animate-pulse" />
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-5xl mx-auto sm:max-lg:mb-20">
            ...
            <nav className="flex items-center gap-1.5 text-xs text-[#999] mb-6">
                <Link href="/catalog/ready-to-wear" className="hover:text-[#C2185B] transition-colors">
                    Shop
                </Link>
                <ChevronRight size={12} />
                <Link href="#" className="hover:text-[#C2185B] transition-colors" onClick={(e) => { e.preventDefault(); /* open cart */ }}>
                    Cart
                </Link>
                <ChevronRight size={12} />
                <span className="text-[#0D0D0D] font-medium">Checkout</span>
            </nav>
                ...
                <div className="space-y-5 min-w-0">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2.5 px-5 py-4 border-b border-[rgba(0,0,0,0.06)]">
                            ...
                            <h2 className="font-semibold text-sm text-[#0D0D0D]">
                                Order Summary
                            </h2>
                        ...
                        <div className="divide-y divide-[rgba(0,0,0,0.04)]">
                            {items.map((item) => (
                                <div key={item.id} className="flex items-center gap-3 px-5 py-4">
                                    {/* Thumbnail */}
                                    <div className="w-14 h-18 rounded-lg bg-[#F4F0F8] overflow-hidden shrink-0 relative">
                                        {item.readyToWear?.images?.[0] ? (
                                            <Image
                                                src={item.readyToWear.images[0]}
                                                alt={item.readyToWear.name}
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-sm font-semibold font-mono text-[#0D0D0D] mt-1">
                        ...
                        {/* Subtotal */}
                        <div className="flex items-center justify-between px-5 py-4 bg-[#FAFAFA] border-t border-[rgba(0,0,0,0.06)]">
                            <p className="text-sm text-[#555]">Subtotal</p>
                            <p className="text-lg font-bold font-mono text-[#0D0D0D]">
                    ...
                    >
                        ...
                        <div className="px-5 py-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="flex items-start gap-3">
                                <div className="w-8 h-8 rounded-full bg-[#F4F0F8] flex items-center justify-center shrink-0">
                                    <Mail size={13} className="text-[#C2185B]" />
                                </div>
                                <div className="min-w-0">
                                    <p className="text-[11px] text-[#999] uppercase tracking-wider mb-0.5">Email</p>
                                    <p className="text-sm font-medium text-[#0D0D0D] truncate break-all">{user?.email || "—"}</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="w-8 h-8 rounded-full bg-[#F4F0F8] flex items-center justify-center shrink-0">
                                    <Phone size={13} className="text-[#C2185B]" />
                                </div>
                                <div className="min-w-0">
                            ...
                            {user?.address && (
                                <div className="flex items-start gap-3 sm:col-span-2">
                                    <div className="w-8 h-8 rounded-full bg-[#F4F0F8] flex items-center justify-center shrink-0">
                                        <MapPin size={13} className="text-[#C2185B]" />
                                    </div>
                                    <div className="min-w-0">
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`relative flex items-start gap-3 p-4 rounded-xl border-2 text-left transition-all duration-150 ${isSelected
                                                ...
                                                : "border-[#E0E0E0] bg-white hover:border-[#C2185B]/30 hover:bg-[#FAFAFA]"
                                                }`}
                                        >
                                                ...
                                                <div className="flex items-start gap-3 p-3 rounded-lg bg-[#F4F0F8]">
                                                    ...
                                                    <div>
                                                        <Label
                                                            ...
                                                            className="text-sm font-medium text-[#0D0D0D] cursor-pointer leading-snug"
                                                        >
                                                ...
                                                >
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        <Textarea
                                                            ...
                                                            className="pl-9 resize-none border-[#E0E0E0] focus-visible:ring-[#C2185B] focus-visible:border-[#C2185B] min-h-[90px]"
                                                        />
                                                    </div>
                                                </motion.div>
                                            )}
                    ...
                    >
                        ...
                        <div className="px-5 py-4">
                            <Textarea
                                ...
                                maxLength={500}
                                className="resize-none border-[#E0E0E0] focus-visible:ring-[#C2185B] focus-visible:border-[#C2185B] min-h-[90px]"
                            />
                            <p className="text-xs text-[#999] mt-1.5 text-right">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Label
                                htmlFor="authorised"
                                className="text-sm text-[#555] leading-relaxed cursor-pointer inline"
                            >
                                I have reviewed my order details and confirm that all information is correct. I
                                understand I will need to make a{" "}<span className="font-semibold text-[#C2185B]">full payment</span>{" "}to the provided
