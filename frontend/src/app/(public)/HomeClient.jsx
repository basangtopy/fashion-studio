...
export function HeroSection() {
    ...
    return (
        <section ref={sectionRef} className="relative min-h-[100dvh] flex flex-col xl:flex-row xl:bg-secondary">
            ...
            <div className="xl:hidden absolute inset-0 w-full h-full overflow-hidden z-0">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-brand-secondary to-[#F8E8F0]/10" />
                ...
                <div className="absolute top-[10%] -left-10 w-64 h-80 rounded-full bg-primary/10 blur-3xl" />
            ...
            <div className="relative w-full xl:w-[60%] h-[100dvh] xl:h-auto xl:bg-secondary flex items-end xl:items-center z-10">
            ...
            <div className="hidden xl:flex w-[40%] bg-secondary relative overflow-hidden items-center justify-center">
                <motion.div
                ...
                >
                    ...
                    <motion.div style={{ y: shapeY1 }} className="absolute inset-0">
                        <div className="absolute -top-4 -left-4 w-64 h-80 rounded-3xl bg-primary/20 rotate-2" />
                    ...
                    <motion.div style={{ y: shapeY2 }} className="absolute inset-0">
                        <div className="absolute top-12 right-20 w-40 h-52 rounded-2xl bg-primary/15 rotate-6" />
                        <div className="absolute bottom-16 left-8 w-36 h-44 rounded-2xl bg-[#F8E8F0]/8 -rotate-4" />
                        <div className="absolute top-1/2 left-1/3 w-24 h-28 rounded-xl bg-primary/10 -rotate-2" />
                    </motion.div>
    ...
    return (
        <section ref={ref} className="section-gap bg-white">
            <div className="page-container">
                ...
                <div className="hidden lg:grid lg:grid-cols-3 gap-6 lg:gap-8">
                    {models.map((model, i) => (
                        <motion.div
                            ...
                            className="group flex flex-col p-8 rounded-xl border border-border bg-white card-hover h-full"
                        >
                            <div className="w-14 h-14 rounded-xl bg-[#F8E8F0] flex items-center justify-center mb-6 group-hover:bg-primary/10 transition-colors">
                            ...
                            <Link
                                href={model.link}
                                className="inline-flex items-center gap-1 text-sm font-semibold text-primary hover:gap-2 transition-all mt-auto"
                            >
                ...
                <div className="lg:hidden flex gap-4 overflow-x-auto pb-4 no-scrollbar snap-x snap-mandatory -mx-6 px-6">
                    {models.map((model, i) => (
                        <motion.div
                            ...
                            className="group shrink-0 w-[280px] snap-center p-6 rounded-xl border border-border bg-white"
                        >
                            <div className="w-12 h-12 rounded-xl bg-[#F8E8F0] flex items-center justify-center mb-5 group-hover:bg-primary/10 transition-colors">
                                <model.icon size={20} className="text-primary" />
                            </div>
                ...
                {/* Mobile: Swipe hint */}
                <div className="lg:hidden mt-4 flex items-center justify-center gap-1.5 text-xs font-medium text-text-light">
...
// ============================================================
export function FeaturedStylesSection({ initialData = [] }) {
    const { ref, isVisible } = useScrollReveal();
    ...
    const { data: styles, isLoading } = useQuery({
        ...
        staleTime: 60 * 60 * 1000, // treat server-fetched data as fresh for 1 hour
    });

    // Show skeletons only while genuinely loading (no server data + no client data yet)
    if (isLoading && !styles?.length) {
        return (
            <section className="section-gap bg-surface-2">
                <div className="page-container">
                    <div className="flex items-end justify-between mb-12">
                        <div>
                            <div className="h-8 w-48 bg-input rounded animate-pulse mb-3" />
                    ...
                    <div
                        ...
                        style={{ gridTemplateColumns: '2fr 1fr 1fr', gridTemplateRows: '340px 240px', gap: '4px' }}
                    >
                        {[
                            ...
                            <div
                                key={i}
                                className="rounded-xl bg-shimmer animate-pulse"
                    ...
                    <div className="grid gap-1 lg:hidden" style={{ gridTemplateColumns: 'repeat(2, 1fr)' }}>
                        {[...Array(4)].map((_, i) => (
                            <div
                                key={i}
                                className={`rounded-xl bg-shimmer animate-pulse ${i === 0 || i === 3 ? "col-span-2 h-[240px]" : "col-span-2 sm:col-span-1 h-[200px]"}`}
                            />
                        ))}
                    </div>
                </div>
    ...
    return (
        <section ref={ref} className="section-gap bg-surface-2">
            <div className="page-container">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={isVisible ? { opacity: 1, y: 0 } : {}}
                ...
                >
                    <div>
                        ...
                        <p className="text-muted-foreground">Explore our curated collection of fashion styles.</p>
                    </div>
                    <Link
                        href="/catalog/styles"
                ...
                >
                    {displayStyles.slice(0, 4).map((style, i) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-brand-secondary/40 to-[#F8E8F0]/20">
                                {style.images?.[0] ? (
                                    <>
                                        {/* blurred background */}
                                        < Image
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-brand-secondary/80 via-brand-secondary/20 to-transparent [@media(hover:hover)]:bg-none [@media(hover:hover)]:bg-secondary/0 [@media(hover:hover)]:group-hover:bg-secondary/70 transition-all duration-300 flex items-end p-6">
                    ...
                    {displayStyles.slice(0, 4).map((style, i) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-brand-secondary/80 via-brand-secondary/20 to-transparent flex items-end p-4">
                ...
                <Link
                    href="/catalog/styles"
                    className="sm:hidden flex items-center justify-center gap-1 mt-8 text-sm font-semibold text-primary"
                >
                    View all styles <ArrowRight size={14} />
                </Link>
            </div>
...
// ============================================================
export function ReadyToWearSection({ initialData = [] }) {
    const { ref, isVisible } = useScrollReveal();
    ...
    const { data: items, isLoading } = useQuery({
        ...
        initialData: initialData.length > 0 ? initialData : undefined,
        staleTime: 30 * 60 * 1000, // 30 minutes — stock changes more often
    });
            ...
            <section className="section-gap bg-secondary">
                <div className="page-container">
                    <div className="flex items-end justify-between mb-10">
                        <div>
                            <div className="h-8 w-40 bg-white/10 rounded animate-pulse mb-3" />
                            <div className="h-4 w-52 bg-white/10 rounded animate-pulse" />
                        </div>
                    </div>
                    <div className="flex gap-4 lg:gap-6 overflow-hidden">
                        {[...Array(4)].map((_, i) => (
                            <div key={i} className="shrink-0 w-[240px] lg:w-[260px]">
                                <div className="h-[300px] lg:h-[320px] rounded-xl bg-white/10 animate-pulse mb-3" />
    ...
    return (
        <section ref={ref} className="section-gap bg-secondary">
            <div className="page-container">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={isVisible ? { opacity: 1, y: 0 } : {}}
                ...
                >
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Link
                            ...
                            className="hidden sm:flex items-center gap-1 text-sm font-semibold text-primary hover:gap-2 transition-all ml-2"
                        >
                        ...
                        {displayItems.map((item, i) => (
                            ...
                            >
                                <Link href={`/catalog/ready-to-wear/${item.id}`} className="group block">
                                    <div className="relative h-[300px] lg:h-[320px] rounded-xl overflow-hidden bg-brand-secondary-light mb-3">
                                        {item.images?.[0] ? (
                                            <>
                                                <Image
                                                    src={item.images[0]}
                                            ...
                                            <div className="w-full h-full bg-gradient-to-br from-primary/20 to-brand-secondary-light" />
                                        )}
...
// ============================================================
export function PortfolioSection({initialData=[]}) {
    const { ref, isVisible } = useScrollReveal();
        ...
        return (
            <section className="section-gap bg-white">
                <div className="page-container">
                    <div className="flex items-end justify-between mb-12">
                        <div>
                            <div className="h-8 w-72 bg-input rounded animate-pulse mb-3" />
                    ...
                    <div className="hidden lg:flex flex-col" style={{ gap: '4px' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', height: '440px', gap: '4px' }}>
                            <div className="rounded-xl bg-shimmer animate-pulse" />
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', height: '260px', gap: '4px' }}>
                            {[...Array(3)].map((_, i) => (
                                <div key={i} className="rounded-xl bg-shimmer animate-pulse" />
                            ))}
                        </div>
                    </div>
                    {/* Mobile skeleton */}
                    <div className="lg:hidden flex flex-col" style={{ gap: '4px' }}>
                        <div className="h-[280px] rounded-xl bg-shimmer animate-pulse" />
                        <div className="grid grid-cols-2" style={{ gap: '4px' }}>
                            <div className="h-[140px] rounded-xl bg-shimmer animate-pulse" />
                            <div className="h-[140px] rounded-xl bg-shimmer animate-pulse" />
                        </div>
                    </div>
                </div>
            ...
            <div className="page-container">
                ...
                {displayEntries.length === 0 ? (
                    <div className="text-center py-16">
                        <p className="text-text-light text-sm">Portfolio pieces coming soon.</p>
                    </div>
                ) : (
                    <>
                        ...
                        {(() => {
                            ...
                            const renderItem = (entry, i, isLarge = false) => (
                                ...
                                >
                                    <div className="absolute inset-0 bg-gradient-to-br from-brand-secondary/30 to-primary/20">
                                        {entry.images?.[0] && (
                                            <>
                            ...
                            return (
                                <div className="hidden lg:flex flex-col" style={{ gap: '4px' }}>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', height: '360px', gap: '4px' }}>
                                        {/* Text/CTA panel */}
                                        <div className="flex flex-col justify-between rounded-xl p-8" style={{ background: 'var(--color-brand-secondary)' }}>
                                            <div>
                                                <span className="text-[10px] uppercase tracking-[0.3em] text-primary mb-3 block">Studio ethos</span>
                            ...
                            {(() => {
                                ...
                                return (
                                    <>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2" style={{ gap: '4px' }}>
                                            <div className="flex flex-col justify-between rounded-xl p-6 sm:p-8 h-auto sm:h-[280px]" style={{ background: 'var(--color-brand-secondary)' }}>
                                                <div>
                                                    <span className="text-[10px] uppercase tracking-[0.3em] text-primary mb-2 block">Studio ethos</span>
...
export function TestimonialsSection({initialData=[]}) {
    ...
    const { data: testimonials, isLoading } = useQuery({
        ...
        initialData: initialData.length > 0 ? initialData : undefined,
        staleTime: 24 * 60 * 60 * 1000, // testimonials rarely change — 24 hours
    });

    // Skeleton shown only on the rare path where server fetch failed AND client is loading
    if (isLoading && !testimonials?.length) {
        return (
            <section className="section-gap bg-surface-3">
                <div className="page-container">
                    <div className="text-center mb-12">
                        <div className="h-8 w-56 bg-input rounded animate-pulse mx-auto mb-3" />
                        <div className="h-4 w-40 bg-input rounded animate-pulse mx-auto" />
                    </div>
                    <div className="hidden md:grid md:grid-cols-3 gap-6">
                        {[...Array(3)].map((_, i) => (
                            <div key={i} className="p-6 lg:p-8 rounded-xl bg-white border border-[rgba(0,0,0,0.06)]">
                                <div className="flex gap-1 mb-4">
                                    {[...Array(5)].map((_, j) => (
                                        <div key={j} className="w-4 h-4 rounded bg-shimmer animate-pulse" />
                                    ))}
                                </div>
                                <div className="space-y-2 mb-6">
                                    <div className="h-3 bg-shimmer rounded animate-pulse" />
                                    <div className="h-3 bg-shimmer rounded animate-pulse w-5/6" />
                                    <div className="h-3 bg-shimmer rounded animate-pulse w-4/6" />
                                </div>
                                <div className="h-4 w-20 bg-shimmer rounded animate-pulse" />
                            </div>
                        ))}
                    </div>
                    {/* Mobile skeleton */}
                    <div className="md:hidden space-y-4">
                        {[...Array(2)].map((_, i) => (
                            <div key={i} className="p-6 rounded-xl bg-white border border-[rgba(0,0,0,0.06)]">
                                <div className="flex gap-1 mb-3">
                                    {[...Array(5)].map((_, j) => (
                                        <div key={j} className="w-3.5 h-3.5 rounded bg-shimmer animate-pulse" />
                                    ))}
                                </div>
                                <div className="space-y-2 mb-4">
                                    <div className="h-3 bg-shimmer rounded animate-pulse" />
                                    <div className="h-3 bg-shimmer rounded animate-pulse w-4/5" />
                                </div>
                                <div className="h-4 w-16 bg-shimmer rounded animate-pulse" />
                            </div>
                        ))}
                    </div>
                </div>
    ...
    return (
        <section ref={ref} className="section-gap bg-muted">
            <div className="page-container">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={isVisible ? { opacity: 1, y: 0 } : {}}
                ...
                <div className="hidden md:grid md:grid-cols-3 gap-6">
                    {displayTestimonials.map((testimonial, i) => (
                        <motion.div
                            ...
                            transition={{ duration: 0.5, delay: i * 0.12 }}
                            className="relative p-6 lg:p-8 rounded-xl bg-white border border-border"
                        >
                            {/* Large decorative quotation mark — behind card content */}
                            <span className="absolute top-2 left-4 text-[80px] lg:text-[100px] font-serif leading-none text-primary/10 pointer-events-none select-none" aria-hidden="true">
                                &ldquo;
                            </span>
                ...
                <div className="md:hidden space-y-4">
                    {displayTestimonials.map((testimonial, i) => (
                        ...
                        >
                            <span className="absolute top-1 left-3 text-[60px] font-serif leading-none text-primary/10 pointer-events-none select-none" aria-hidden="true">
                                &ldquo;
                            </span>
                            <div className="relative z-[1]">
                ...
                <div className="text-center mt-10">
                    <Link
                        ...
                        className="inline-flex items-center gap-1 text-sm font-semibold text-primary hover:gap-2 transition-all"
                    >
                        What Our Clients Say <ArrowRight size={14} />
                    </Link>
                </div>
            </div>
        </section>
...
export function CTASection() {
    ...
    return (
        <section
            ref={ref}
            className="relative py-20 lg:py-24 bg-primary overflow-hidden"
        >
            ...
            <div className="page-container relative z-10">
                ...
                >
                    ...
                    <Link
                        href={bookUrl}
                        scroll={false}
                        className="inline-flex items-center gap-2 px-8 py-3.5 rounded-md bg-white text-primary font-semibold hover:bg-[#F8E8F0] transition-colors"
                    >
                        <Calendar size={16} />
                        Book a Fitting
                    </Link>
