...
export default function PortfolioContent({ initialEntries = [], initialCategories = [] }) {
    ...
    const { data: items = [], isLoading } = useQuery({
        ...
        initialData: category === "All" && initialEntries.length > 0
            ? initialEntries
            : undefined,
    ...
    return (
        <div className="pt-[var(--nav-height)]">
            {/* Header */}
            <div className="bg-secondary py-10 sm:py-12 lg:py-16">
                        ...
                        {Array.from({ length: 8 }).map((_, i) => {
                            ...
                            return (
                                <div key={i} style={{ display: "contents" }}>
                                    ...
                                    <div
                                        className={`lookbook-item ${sizeClass} animate-pulse bg-muted rounded-2xl`}
                                    />
                                </div>
                            );
                        })}
